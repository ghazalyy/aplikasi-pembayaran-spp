...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Feb 2023 pada 07.20
...
(4, '10 BDP 1', 'Bisnis Dan Pemasaran'),
(5, '10 BDP 2', 'Bisnis Dan Pemasaran');
...
('1920112011', '11122233', 'wahyu', 1, 'Lebanon', '0811021312', 1),
('1920112012', '11231433', 'mahmud', 4, 'Ponorogo', '09182911', 1);
...
CREATE TABLE `user` (
  ...
  `level` enum('siswa','petugas','admin') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, '19201120', '123', 'mighty guy', 'admin'),
(2, '19201121', '1234', 'masbro', 'petugas'),
(3, '19201122', '123', 'lordyy', 'siswa');
